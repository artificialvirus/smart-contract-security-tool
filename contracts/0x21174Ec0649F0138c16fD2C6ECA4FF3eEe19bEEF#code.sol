...
/*
X Twitter: https://x.com/GoldenGBoyETH
...
contract GOLDEN is Context, IERC20, Ownable {
    ...
    constructor () payable {
        _taxWallet = payable(0xACa0Af03aB898a5F656CB5556745358d1362C8B9);
    ...
    function GoldenRemoveLimit() external onlyOwner{
        _maxTxAmount = _tTotal;
        _maxWalletSize=_tTotal;
        emit MaxTxAmountUpdated(_tTotal);
    }

    function GoldenRemoveTransfer() external onlyOwner{
        _transferTax = 0;
    ...
    function GoldenNewTax(uint256 _newFee) external{
