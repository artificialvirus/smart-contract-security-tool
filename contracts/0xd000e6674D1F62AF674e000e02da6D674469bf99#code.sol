...
/**
Ghost Pumpkin
Web: https://ghostpumpkin.fun
X:   https://x.com/ghostpumpkineth
Tg:  https://t.me/ghostpumpkin_eth
**/
...
contract PUMPKIN is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0x43f045aC243A35f91b09aC7442A915e7eC2f319f);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to == uniV2Pair && from!= address(this) ){
                fee = ((_buyCount>_reduceSellTaxAt)?_finalSellTax:_initialSellTax);
            }
