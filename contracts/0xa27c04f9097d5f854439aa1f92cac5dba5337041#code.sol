...
/*
Bloop Furpal isn't just another memecoin - he is one
of the original hand-drawn Hedz characters created
by the legendary Matt Furie himself. Jump in and ride
the wave of crypto history with a coin as iconic as
its creator!

https://blooptoken.fun/
https://x.com/Bloop_ERC20
https://t.me/BloopERC20
*/
...
contract BLOOP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bloop by 𝓜𝓪𝓽𝓽 𝓕𝓾𝓻𝓲𝓮";
    ...
    constructor () {
        _taxWallet = payable(0xAf1E0cF7A77a131B253C69a67e2578be8F72d5B1);
